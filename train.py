...
def get_input_args():
    ...
    parser.add_argument('--data_dir', type=str, default='flowers', help='Path to the image files. Expected subdirectories are ./train, ./valid, ./test')
...
def load_data(data_dir):
    ...
    valid_datasets = datasets.ImageFolder(valid_dir, transform=val_transforms)
